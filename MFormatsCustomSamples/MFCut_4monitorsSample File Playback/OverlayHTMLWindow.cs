...
namespace SampleFilePlayback
{
    ...
    public partial class OverlayHTMLWindow : Form
    {
        ...
        private MousePos GetPos(double _x, double _y)
        {
            ...
            if ((double)m_vProps.nWidth / m_vProps.nHeight > (double)panelPreview.Width / panelPreview.Height)
            {
                mousePosReturn.dblX = _x / panelPreview.Width;

                double dblHeighInt = (double)panelPreview.Width * m_vProps.nHeight / m_vProps.nWidth;
            ...
            else
            {
                ...
                double dblWidthInt = (double)panelPreview.Height * m_vProps.nWidth / m_vProps.nHeight;
