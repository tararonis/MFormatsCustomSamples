...
{
    public partial class TextGradientEditor : UserControl
    {
        ...
        {
            SpinnerGradientAngle.Value = (decimal)m_Item.TextColorAngle;
        }
        ...
        private void SetColorAngle()
        {
            if (m_Item != null && m_bChangedByUI)
            {
                ...
                m_bAceptExternalUpdate = false;
                m_Item.TextColorAngle = dblAngle;
                m_bAceptExternalUpdate = true;
            }
        }
