...
namespace SampleFilePlayback
{
    public partial class MainForm : Form
    {
        ...
        private MFPreviewClass m_objPreview1;
        private MFPreviewClass m_objPreview2;
        private MFPreviewClass m_objPreview3;
        private MFPreviewClass m_objPreview4;
        ...
        private bool NextFrame()
        {
            ...
            try
            {
                ...
                MFFrame frameScreen1 = null;
                MFFrame frameScreen2 = null;
                MFFrame frameScreen3 = null;
                MFFrame frameScreen4 = null;

                if (Cut_chb.Checked)
                {
                    pFrame.MFCut(-1, ref screen1, out frameScreen1);
                    pFrame.MFCut(-1, ref screen2, out frameScreen2);
                    pFrame.MFCut(-1, ref screen3, out frameScreen3);
                    pFrame.MFCut(-1, ref screen4, out frameScreen4);
                    m_objPreview1.ReceiverFramePut(frameScreen1, 0, "");
                    //m_objPreview1.PreviewFullScreen("", 1, 0);

                    
                    m_objPreview2.ReceiverFramePut(frameScreen2, 0, "");
                    //m_objPreview2.PreviewFullScreen("", 1, 1);

                    
                    m_objPreview3.ReceiverFramePut(frameScreen3, 0, "");
                    //m_objPreview3.PreviewFullScreen("", 1, 2);

                    
                    m_objPreview4.ReceiverFramePut(frameScreen4, 0, "");
                    //m_objPreview4.PreviewFullScreen("", 1, 3);

                    releaseComObj(frameScreen1);
                    releaseComObj(frameScreen2);
                    releaseComObj(frameScreen3);
                    releaseComObj(frameScreen4);
                    int a = 6;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            m_objPreview1.PreviewWindowSet("", screen1_pnl.Handle.ToInt32());
            m_objPreview1.PreviewEnable("", 0, 1);
            m_objPreview2.PreviewWindowSet("", screen2_pnl.Handle.ToInt32());
            m_objPreview2.PreviewEnable("", 0, 1);
            m_objPreview3.PreviewWindowSet("", screen3_pnl.Handle.ToInt32());
            m_objPreview3.PreviewEnable("", 0, 1);
            m_objPreview4.PreviewWindowSet("", screen4_pnl.Handle.ToInt32());
