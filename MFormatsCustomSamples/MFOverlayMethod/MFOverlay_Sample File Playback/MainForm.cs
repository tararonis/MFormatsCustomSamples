...
namespace SampleFilePlayback
{
    public partial class MainForm : Form
    {
        ...
        private MFReaderClass m_objMFReader2;
        ...
        private bool NextFrame()
        {
            ...
            lock (m_objLock) // For prevent reader replace in OpenFile() and overlay change
            {
                ...
                try
                {
                    ...
                    {
                        M_AV_PROPS m_avProps = new M_AV_PROPS();
                        m_avProps.vidProps.eVideoFormat = eMVideoFormat.eMVF_HD1080_25p;
                        M_AV_PROPS m_avProps2 = new M_AV_PROPS();
                        m_avProps2.vidProps.nHeight = 300;
                        m_avProps2.vidProps.nWidth = 300;
                        m_avProps2.vidProps.dblRate = 25;


                        m_objMFReader.SourceFrameConvertedGetByTime(ref m_avProps, dblRequest, -1, out pFrame, "");
                        if (m_objMFReader2 != null)
                        {
                           
                            m_objMFReader2.SourceFrameConvertedGetByTime(ref m_avProps2, dblRequest, -1, out pFrame2, "");
                            
                        }
                    }
                    if (Overlay_chb.Checked & pFrame != null & pFrame2 != null)                    {

                        pFrame.MFOverlay(pFrame2, null, 100, 100, 1, "audio_gain=-10", "ch1");                        
                    }
            ...
            try
            {
                ...
                //pFrame.MFResize(eMFCC.eMFCC_Default, 250, 250, 0, out pFrame, "", "");
        ...
        private void ChangeFont_btn_Click(object sender, EventArgs e)
        {
            string itemID;
            string itemXML;
            string compostionID = "myComposition";
            int itemIndex = 0;
            m_objCharGen.CompositionsGetItem(compostionID, itemIndex, out itemID, out itemXML);
