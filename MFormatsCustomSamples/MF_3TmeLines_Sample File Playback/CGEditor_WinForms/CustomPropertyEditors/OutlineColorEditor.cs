...
{
    public partial class OutlineColorEditor : UserControl
    {
        ...
        private void GetColor()
        {
            ...
            string strColor = m_Item.OutlineColor;
        ...
        {
            SpinnerOutlineWidth.Value = (decimal)m_Item.OutlineWidth;
        }
        ...
        private void SetColor()
        {
            if (m_Item != null && m_bChangedByUI)
            {
                ...
                m_Item.OutlineColor = strCGGradient;
                m_bAceptExternalUpdate = true;
            }
        }
