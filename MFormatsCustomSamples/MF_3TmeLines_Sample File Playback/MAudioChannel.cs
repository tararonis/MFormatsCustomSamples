...
namespace SampleFilePlayback
{
    public partial class MAudioChannel : Control
    {
        ...
        private void MAudioCh_Paint(object sender, PaintEventArgs e)
        {
            ...
            float fIndent = 3.0f;
            float fGainH = 2.0f;
            RectangleF rcBack = new RectangleF(fIndent, fGainH / 2.0f, this.Bounds.Width - fIndent * 2, this.Bounds.Height - fGainH);
        ...
        private void MAudioCh_MouseMove(object sender, MouseEventArgs e)
        {
            float fIndent = 3.0f;
            float fGainH = 2.0f;
            RectangleF rcBack = new RectangleF(fIndent, fGainH / 2.0f, this.Bounds.Width - fIndent * 2, this.Height - fGainH);
