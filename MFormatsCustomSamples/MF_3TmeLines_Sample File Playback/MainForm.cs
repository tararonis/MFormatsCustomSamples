...
namespace SampleFilePlayback
{
    public partial class MainForm : Form
    {
        ...
        private bool NextFrame()
        {
            ...
            lock (m_objLock) // For prevent reader replace in OpenFile() and overlay change
            {
                ...
                try
                {
                    ...
                    // Update avProps. Need for HTML plugin.
                    if (pFrame != null)
                    {
                        int nASamples = 0;
                        pFrame.MFAVPropsGet(out m_avProps, out nASamples);
                    }
                }
        ...
        {
            double dblPos = (double)mTime.rtStartTime / 10000000;
        ...
        {
            overlayHTMLWind = new OverlayHTMLWindow(m_objOverlayHTML, m_objMFReader, m_avProps.vidProps);
        ...
        private void Add3TL_btn_Click(object sender, EventArgs e)
        {

            string m_strItemIDFirst = "";
            string m_strItemIDSecond = "";
            if (checkBoxCG.Checked)
            {
                //m_objCharGen = new MLCHARGENLib.CoMLCharGen();


                m_objCharGen.AddNewItem("First Item", 0.1, 0.1, 1, 0, ref m_strItemIDFirst);
                m_objCharGen.SetItemProperties(m_strItemIDFirst, "movement::speed-x", "1", "", 0);
                m_objCharGen.SetItemProperties(m_strItemIDFirst, "cg-props::height", "1", "", 0);
                m_objCharGen.SetItemProperties(m_strItemIDFirst, "cg-props::width", "1", "", 0);
                m_objCharGen.ShowItem(m_strItemIDFirst, 1, 0);

                CG_TEXT_PROPS textProps = new CG_TEXT_PROPS();
                textProps.eTextType = eCG_TextType.eCGTT_Timer;                

                m_objCharGen.AddNewTextItem(ref textProps, 0.3, 0.3, 1, 0, ref m_strItemIDSecond);

                //m_objCharGen.AddNewItem("Second Item", 0.3, 0.3, 1, 0, ref m_strItemIDSecond);
                m_objCharGen.SetItemProperties(m_strItemIDSecond, "movement::speed-x", "1", "", 0);
                m_objCharGen.SetItemProperties(m_strItemIDSecond, "cg-props::height", "1", "", 0);
                m_objCharGen.SetItemProperties(m_strItemIDSecond, "cg-props::width", "1", "", 0);
                m_objCharGen.ShowItem(m_strItemIDSecond, 1, 0);

                #region 1 timeline
                CG_SCHEDULE_TIMES myTime1 = new CG_SCHEDULE_TIMES();
                myTime1.dblScheduledTime = 0.0;
                myTime1.dblShowTime = 0.0; 
                myTime1.dblExitTime = 0.0;
                myTime1.dblIntroTime = 0.0;
                myTime1.nShowHide = 1;
                string newTimeLineID1 = "newTimeline";
                string targetItemID1 = m_strItemIDFirst;
                string targetItemProps1 = "cg-props::show='yes' text::color='Red' cg-props::height='100' cg-props::width='500'";
                #endregion

                #region 2 timeline
                CG_SCHEDULE_TIMES myTime2 = new CG_SCHEDULE_TIMES();
                myTime2.dblScheduledTime = 3.0; //  2 min
                myTime2.dblShowTime = 0.0; 
                myTime2.dblExitTime = 0.0;
                myTime2.dblIntroTime = 0.0;
                myTime2.nShowHide = 1;
                string newTimeLineID2 = "newTimeline";
                string targetItemID2 = m_strItemIDSecond;
                string targetItemProps2 = "cg-props::show='yes' cg-props::height='200' cg-props::width='600' text::color='Red' cg-props::pause='no'";
                #endregion

                
                //TimeLines to make items disappear.
                #region 3 timeline
                CG_SCHEDULE_TIMES myTime3 = new CG_SCHEDULE_TIMES();
                myTime3.dblScheduledTime = 6.0;  // 4 min
                myTime3.dblShowTime = 0.0;
                myTime3.dblIntroTime = 0.0;
                string newTimeLineID3 = "newTimeline";
                string targetItemID3 = m_strItemIDFirst;
                string targetItemProps3 = "cg-props::show='no'";
                #endregion

                #region 4 timeline
                CG_SCHEDULE_TIMES myTime4 = new CG_SCHEDULE_TIMES();
                myTime4.dblScheduledTime = 10.0; // end of the item
                myTime4.dblShowTime = 0.0; 
                myTime4.dblExitTime = 0.0;
                myTime4.dblIntroTime = 0.0;                
                string newTimeLineID4 = "newTimeline";
                string targetItemID4 = m_strItemIDSecond;
                string targetItemProps4 = "cg-props::show='no'";
                #endregion

                (m_objCharGen as IMLCharGenSchedule).ScheduleAdd(newTimeLineID1, targetItemID1, targetItemProps1, ref myTime1);
                (m_objCharGen as IMLCharGenSchedule).ScheduleAdd(newTimeLineID2, targetItemID2, targetItemProps2, ref myTime2);
                (m_objCharGen as IMLCharGenSchedule).ScheduleAdd(newTimeLineID3, targetItemID3, targetItemProps3, ref myTime3);
                (m_objCharGen as IMLCharGenSchedule).ScheduleAdd(newTimeLineID4, targetItemID4, targetItemProps4, ref myTime4);
                ...
                int stopOthers = 0;
                (m_objCharGen as IMLCharGenSchedule).ScheduleTimelineStart(targetTimeline, startTime, cycleTime, stopOthers);
